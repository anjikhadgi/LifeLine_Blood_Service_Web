            ...
            <section className="hidden lg:block">
              <div className="max-w-2xl space-y-6 text-white">
                ...
                <h1 className="max-w-xl text-5xl font-semibold tracking-tight text-white xl:text-6xl">
                  Create your account and join a life-saving network.
                </h1>
                <p className="max-w-xl text-lg leading-8 text-white/75">
                  Register as a donor or organization to manage profiles, blood requests, and donation coordination from one secure place.
                </p>

                <div className="grid max-w-xl gap-4 sm:grid-cols-3">
                  <div className="rounded-2xl border border-white/10 bg-white/8 p-4 backdrop-blur-md">
                    <div className="text-2xl font-semibold text-white">Quick</div>
                    <div className="mt-1 text-sm text-white/70">Fast account setup</div>
                  </div>
                  <div className="rounded-2xl border border-white/10 bg-white/8 p-4 backdrop-blur-md">
                    <div className="text-2xl font-semibold text-white">Flexible</div>
                    <div className="mt-1 text-sm text-white/70">Donor or organization</div>
                  </div>
                  <div className="rounded-2xl border border-white/10 bg-white/8 p-4 backdrop-blur-md">
                    <div className="text-2xl font-semibold text-white">Secure</div>
                    <div className="mt-1 text-sm text-white/70">Protected account access</div>
                  </div>
                </div>
              </div>
            </section>
